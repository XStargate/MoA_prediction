...
def process(train_features, test_features, train_targets_scored, train_targets_nonscored=None):
    if train_targets_scored is not None:
...
""" def make_cv_folds(train, seeds, nfolds, target_cols):
