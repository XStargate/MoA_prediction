...
test_features_private = pd.read_csv('../input/lish-moa/test_features.csv')
...
def run_training(fold, seed):
    ...
    model.load_state_dict(torch.load(f"../input/model-knn-cluster/public/SEED{seed}_FOLD{fold}_scored.pth"))
    model.to(DEVICE)
